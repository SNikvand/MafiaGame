...
exports.listen = function(server) {
    console.log("newest working (hopefully) version");
...
function handleClientDisconnection(socket) {
    socket.on('disconnect', function() {
        ...
        currentRoomPlayer[currentRoom[socket.id]].splice(currentRoomPlayer[currentRoom[socket.id]].indexOf(nickNames[socket.id]), 1);
